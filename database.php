...
class database{
	...
	function input($nama,$alamat,$usia){
		mysqli_query($this->conn,"INSERT INTO t_jurnal9 VALUES('','$nama','$alamat','$usia')");
	...
	function update($id,$nama,$alamat,$usia){
		mysqli_query($this->conn,"UPDATE t_jurnal9 SET nama='$nama', alamat='$alamat', usia='$usia' WHERE id='$id'");
